...
/* $Id: pdf.c,v 1.80.2.20 2016/10/25 12:19:12 rjs Exp $ */
...
PHP_MINFO_FUNCTION(PDFlib)
{
    ...
    php_info_print_table_row(2, "PDFlib GmbH Binary-Version", PDFLIB_VSTRING);
    ...
    php_info_print_table_row(2, "Revision", "$Revision: 1.80.2.20 $" );
